...
local function AddVignetta( ply, text)
	...
	if ply.Vignetta.Emoticon then
		...
		local html="<html><body><p align='center'><img src='"..createurl(ply.Vignetta.Emoticon).."'></p></body></html>"
