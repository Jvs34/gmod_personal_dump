...
SWEP.PrintName			= "Jvs' weapon base."		// 'Nice' Weapon name (Shown on HUD)	
...
function SWEP:DrawHUD()
	self.AmmoDisplayNoAmmo.PrimaryClip=self:GetNWInt("ammo1"); 
end
...
function SWEP:CustomAmmoDisplay()
	self.AmmoDisplayNoAmmo.Draw = true
	//self.AmmoDisplayNoAmmo.PrimaryClip
	self.AmmoDisplayNoAmmo.PrimaryAmmo = LocalPlayer():GetAmmoCount( self.Primary.NoAmmoType )
	return self.AmmoDisplayNoAmmo
end
