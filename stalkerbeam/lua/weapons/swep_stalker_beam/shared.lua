...
//Sigh,i hate to give the weapon a view/world model,if i don't do that,the engine will not call the ViewModelDrawn and the DrawWorldModel
...
function SWEP:Beam(bool)
	if !self.dt.attacking and bool && SERVER then
...
function SWEP:SecondaryAttack()
	if(self.NextScream<CurTime()  && self:CanUpgrade() )then
		self:Upgrade()
		self:UpgradeAmmo();
