	...
	for _,pl in pairs(player.GetAll()) do
		...
		for i,v in pairs(pl:GetWeapons())do
			...
			if !pl.CL_CS_WEPS[v:GetClass()] then
				...
				pl.CL_CS_WEPS[v:GetClass()]:SetOwner(pl)
...
hook.Remove("PostLegsDraw","HG_DrawOnLegs",drawlegsdamnit)
hook.Remove("Think","HG_Think",thinkdamnit)
hook.Remove("PostPlayerDraw","HG_Draw",playerdrawdamnit)
