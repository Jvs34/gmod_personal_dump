...
if SERVER then
	...
	function ENT:DoInitPhysics()
		self:SetCollisionBounds( self.JetBounds.Min , self.JetBounds.Max )
	...
	function ENT:HandleModels()
		self:SetRenderBounds( self.JetBounds.Min , self.JetBounds.Max )
...
function ENT:PredictedJetMove( ply , mv )
