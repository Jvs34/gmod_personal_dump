...
Don't absolutely touch the enums.
*/
//Concepts enum

TLK_CONCEPT_HURT 		=1
TLK_CONCEPT_CHEERS 		=2
TLK_CONCEPT_DANGER		=3
TLK_CONCEPT_WEP_PICKUP	=4
TLK_CONCEPT_SQUAD		=5
TLK_CONCEPT_MEMBER_DEAD	=6
TLK_CONCEPT_IDLE		=7
TLK_CONCEPT_RELOAD		=8
TLK_CONCEPT_QUESTION	=9
TLK_CONCEPT_ANSWER		=10
TLK_CONCEPT_SENTENCE	=11
TLK_CONCEPT_NPCKILLED	=12
TLK_CONCEPT_HEAL		=13
TLK_CONCEPT_AMMO		=14
TLK_CONCEPT_SEEN_ENEMY	=15
TLK_CONCEPT_DIE			=16
//Example

TLK_EXAMPLE={
"vo/npc/male01/question26.wav" //only one sound in this table will be played randomly
}
TLK_EXAMPLE=TLK_CONCEPT_QUESTION //the type of the concept,if is a question,we will tell all the other players
								 //to answer to our question,etc etc

//Useless,since i created SpeakSilent.

/*
TLK_GENERICDEATH={
"common/null.wav"
}
TLK_GENERICDEATH.CONCEPT=TLK_CONCEPT_DIE
*/

//----------------------------------------------------------------------------------
//Male Citizen
//----------------------------------------------------------------------------------
TLK_CIT_MALE_HURT_GENERIC={
...
TLK_CIT_MALE_HURT_GENERIC.CONCEPT=TLK_CONCEPT_HURT

TLK_CIT_MALE_HURT_HEAVY={
	"vo/npc/male01/pain07.wav",
	"vo/npc/male01/pain08.wav",
	"vo/npc/male01/pain09.wav"
}
TLK_CIT_MALE_HURT_HEAVY.CONCEPT=TLK_CONCEPT_HURT

TLK_CIT_MALE_HURT_ARM={
"vo/npc/male01/myarm01.wav",
"vo/npc/male01/myarm02.wav"
}
TLK_CIT_MALE_HURT_ARM.CONCEPT=TLK_CONCEPT_HURT

TLK_CIT_MALE_HURT_LEG={
"vo/npc/male01/myleg01.wav",
"vo/npc/male01/myleg02.wav"
}
TLK_CIT_MALE_HURT_LEG.CONCEPT=TLK_CONCEPT_HURT

TLK_CIT_MALE_HURT_GUT={
"vo/npc/male01/mygut02.wav",
"vo/npc/male01/hitingut01.wav",
"vo/npc/male01/hitingut02.wav"
}
TLK_CIT_MALE_HURT_GUT.CONCEPT=TLK_CONCEPT_HURT
...
TLK_CIT_MALE_CHEER.CONCEPT=TLK_CONCEPT_CHEERS

TLK_CIT_MALE_NPCKILLED={
"vo/npc/male01/likethat.wav",
"vo/npc/male01/gotone01.wav",
"vo/npc/male01/fantastic01.wav"
}
TLK_CIT_MALE_NPCKILLED.CONCEPT=TLK_CONCEPT_NPCKILLED
...
TLK_CIT_MALE_IDLE.CONCEPT=TLK_CONCEPT_IDLE
...
TLK_CIT_MALE_RELOAD.CONCEPT=TLK_CONCEPT_RELOAD
...
TLK_CIT_MALE_DANGER.CONCEPT=TLK_CONCEPT_DANGER

TLK_CIT_MALE_WEP_PICKUP={
...
TLK_CIT_MALE_WEP_PICKUP.CONCEPT=TLK_CONCEPT_WEP_PICKUP
...
TLK_CIT_MALE_HEAL.CONCEPT=TLK_CONCEPT_HEAL
...
TLK_CIT_MALE_AMMO.CONCEPT=TLK_CONCEPT_AMMO

TLK_CIT_MALE_QUESTION={
...
TLK_CIT_MALE_QUESTION.CONCEPT=TLK_CONCEPT_QUESTION
...
TLK_CIT_MALE_ANSWER.CONCEPT=TLK_CONCEPT_ANSWER

TLK_CIT_MALE_SQUAD_JOIN={
"vo/npc/male01/hi01.wav",
"vo/npc/male01/squad_reinforce_single04.wav"
}
TLK_CIT_MALE_SQUAD_JOIN.CONCEPT=TLK_CONCEPT_SQUAD

TLK_CIT_MALE_SQUAD_FOLLOWME={
...
TLK_CIT_MALE_SQUAD_FOLLOWME.CONCEPT=TLK_CONCEPT_SQUAD

TLK_CIT_MALE_SQUAD_TRAITOR={
...
TLK_CIT_MALE_SQUAD_TRAITOR.CONCEPT=TLK_CONCEPT_SQUAD

TLK_CIT_MALE_SQUAD_POSITION={
"vo/npc/male01/illstayhere01.wav",
"vo/npc/male01/littlecorner01.wav",
"vo/npc/male01/holddownspot01.wav"
}
TLK_CIT_MALE_SQUAD_POSITION.CONCEPT=TLK_CONCEPT_SQUAD

TLK_CIT_MALE_SQUAD_MEMBER_DEAD={
...
TLK_CIT_MALE_SQUAD_MEMBER_DEAD.CONCEPT=TLK_CONCEPT_MEMBER_DEAD

TLK_CIT_MALE_SEEN_COMBINE={
"vo/npc/male01/combine01.wav",
"vo/npc/male01/combine02.wav"
}
TLK_CIT_MALE_SEEN_COMBINE.CONCEPT=TLK_CONCEPT_SEEN_ENEMY

TLK_CIT_MALE_SEEN_ZOMBIE={
"vo/npc/male01/zombies01.wav",
"vo/npc/male01/zombies02.wav"
}
TLK_CIT_MALE_SEEN_ZOMBIE.CONCEPT=TLK_CONCEPT_SEEN_ENEMY

TLK_CIT_MALE_SEEN_POLICE={
"vo/npc/male01/civilprotection01.wav",
"vo/npc/male01/civilprotection02.wav"
}
TLK_CIT_MALE_SEEN_POLICE.CONCEPT=TLK_CONCEPT_SEEN_ENEMY

TLK_CIT_MALE_SEEN_HEADCRAB={
"vo/npc/male01/headcrabs01.wav",
"vo/npc/male01/headcrabs02.wav"
}
TLK_CIT_MALE_SEEN_HEADCRAB.CONCEPT=TLK_CONCEPT_SEEN_ENEMY

TLK_CIT_MALE_SEEN_MANHACK={
"vo/npc/male01/itsamanhack01.wav",
"vo/npc/male01/itsamanhack02.wav"
}
TLK_CIT_MALE_SEEN_MANHACK.CONCEPT=TLK_CONCEPT_SEEN_ENEMY

TLK_CIT_MALE_SEEN_SCANNER={
"vo/npc/male01/scanners01.wav",
"vo/npc/male01/scanners02.wav"
}
TLK_CIT_MALE_SEEN_SCANNER.CONCEPT=TLK_CONCEPT_SEEN_ENEMY

TLK_CIT_MALE_SEEN_STRIDER={
"vo/npc/male01/strider.wav"
}
TLK_CIT_MALE_SEEN_STRIDER.CONCEPT=TLK_CONCEPT_SEEN_ENEMY

TLK_CIT_MALE_SEEN_GUNSHIP={
"vo/coast/barn/male01/lite_gunship01.wav",
"vo/coast/barn/male01/lite_gunship02.wav"
}
TLK_CIT_MALE_SEEN_GUNSHIP.CONCEPT=TLK_CONCEPT_SEEN_ENEMY

TLK_CIT_MALE_SEEN_DROPSHIP={
"vo/coast/barn/male01/incomingdropship.wav"
}
TLK_CIT_MALE_SEEN_DROPSHIP.CONCEPT=TLK_CONCEPT_SEEN_ENEMY

//----------------------------------------------------------------------------------
//Female Citizen
//----------------------------------------------------------------------------------
TLK_CIT_FEFEMALE_HURT_GENERIC={
...
TLK_CIT_FEFEMALE_HURT_GENERIC.CONCEPT=TLK_CONCEPT_HURT

TLK_CIT_FEMALE_HURT_HEAVY={
	"vo/npc/female01/pain07.wav",
	"vo/npc/female01/pain08.wav",
	"vo/npc/female01/pain09.wav"
}
TLK_CIT_FEMALE_HURT_HEAVY.CONCEPT=TLK_CONCEPT_HURT

TLK_CIT_FEMALE_HURT_ARM={
"vo/npc/female01/myarm01.wav",
"vo/npc/female01/myarm02.wav"
}
TLK_CIT_FEMALE_HURT_ARM.CONCEPT=TLK_CONCEPT_HURT

TLK_CIT_FEMALE_HURT_LEG={
"vo/npc/female01/myleg01.wav",
"vo/npc/female01/myleg02.wav"
}
TLK_CIT_FEMALE_HURT_LEG.CONCEPT=TLK_CONCEPT_HURT

TLK_CIT_FEMALE_HURT_GUT={
"vo/npc/female01/mygut02.wav",
"vo/npc/female01/hitingut01.wav",
"vo/npc/female01/hitingut02.wav"
}
TLK_CIT_FEMALE_HURT_GUT.CONCEPT=TLK_CONCEPT_HURT

TLK_CIT_FEMALE_CHEER={
"vo/coast/odessa/female01/nlo_cheer01.wav",
"vo/coast/odessa/female01/nlo_cheer02.wav",
"vo/coast/odessa/female01/nlo_cheer03.wav"
}
TLK_CIT_FEMALE_CHEER.CONCEPT=TLK_CONCEPT_CHEERS

TLK_CIT_FEMALE_NPCKILLED={
"vo/npc/female01/likethat.wav",
"vo/npc/female01/gotone01.wav",
"vo/npc/female01/fantastic01.wav"
}
TLK_CIT_FEMALE_NPCKILLED.CONCEPT=TLK_CONCEPT_NPCKILLED
...
TLK_CIT_FEMALE_IDLE.CONCEPT=TLK_CONCEPT_IDLE

TLK_CIT_FEMALE_RELOAD={
"vo/npc/female01/coverwhilereload01.wav",
"vo/npc/female01/coverwhilereload02.wav",
"vo/npc/female01/gottareload01.wav"
}
TLK_CIT_FEMALE_RELOAD.CONCEPT=TLK_CONCEPT_RELOAD

TLK_CIT_FEMALE_DANGER={
...
TLK_CIT_FEMALE_DANGER.CONCEPT=TLK_CONCEPT_DANGER

TLK_CIT_FEMALE_WEP_PICKUP={
...
TLK_CIT_FEMALE_WEP_PICKUP.CONCEPT=TLK_CONCEPT_WEP_PICKUP
...
TLK_CIT_FEMALE_HEAL.CONCEPT=TLK_CONCEPT_HEAL
...
TLK_CIT_FEMALE_AMMO.CONCEPT=TLK_CONCEPT_AMMO

TLK_CIT_FEMALE_QUESTION={
...
TLK_CIT_FEMALE_QUESTION.CONCEPT=TLK_CONCEPT_QUESTION

TLK_CIT_FEMALE_ANSWER={
...
TLK_CIT_FEMALE_ANSWER.CONCEPT=TLK_CONCEPT_ANSWER

TLK_CIT_FEMALE_SQUAD_JOIN={
"vo/npc/female01/hi01.wav",
"vo/npc/female01/squad_reinforce_single04.wav"
}
TLK_CIT_FEMALE_SQUAD_JOIN.CONCEPT=TLK_CONCEPT_SQUAD

TLK_CIT_FEMALE_SQUAD_FOLLOWME={
...
TLK_CIT_FEMALE_SQUAD_FOLLOWME.CONCEPT=TLK_CONCEPT_SQUAD

TLK_CIT_FEMALE_SQUAD_TRAITOR={
...
TLK_CIT_FEMALE_SQUAD_TRAITOR.CONCEPT=TLK_CONCEPT_SQUAD

TLK_CIT_FEMALE_SQUAD_POSITION={
"vo/npc/female01/illstayhere01.wav",
"vo/npc/female01/littlecorner01.wav",
"vo/npc/female01/holddownspot01.wav"
}
TLK_CIT_FEMALE_SQUAD_POSITION.CONCEPT=TLK_CONCEPT_SQUAD

TLK_CIT_FEMALE_SQUAD_MEMBER_DEAD={
...
TLK_CIT_FEMALE_SQUAD_MEMBER_DEAD.CONCEPT=TLK_CONCEPT_MEMBER_DEAD

TLK_CIT_FEMALE_SEEN_COMBINE={
"vo/npc/female01/combine01.wav",
"vo/npc/female01/combine02.wav"
}
TLK_CIT_FEMALE_SEEN_COMBINE.CONCEPT=TLK_CONCEPT_SEEN_ENEMY

TLK_CIT_FEMALE_SEEN_ZOMBIE={
"vo/npc/female01/zombies01.wav",
"vo/npc/female01/zombies02.wav"
}
TLK_CIT_FEMALE_SEEN_ZOMBIE.CONCEPT=TLK_CONCEPT_SEEN_ENEMY

TLK_CIT_FEMALE_SEEN_POLICE={
"vo/npc/female01/civilprotection01.wav",
"vo/npc/female01/civilprotection02.wav"
}
TLK_CIT_FEMALE_SEEN_POLICE.CONCEPT=TLK_CONCEPT_SEEN_ENEMY

TLK_CIT_FEMALE_SEEN_HEADCRAB={
"vo/npc/female01/headcrabs01.wav",
"vo/npc/female01/headcrabs02.wav"
}
TLK_CIT_FEMALE_SEEN_HEADCRAB.CONCEPT=TLK_CONCEPT_SEEN_ENEMY

TLK_CIT_FEMALE_SEEN_MANHACK={
"vo/npc/female01/itsamanhack01.wav",
"vo/npc/female01/itsamanhack02.wav"
}
TLK_CIT_FEMALE_SEEN_MANHACK.CONCEPT=TLK_CONCEPT_SEEN_ENEMY

TLK_CIT_FEMALE_SEEN_SCANNER={
"vo/npc/female01/scanners01.wav",
"vo/npc/female01/scanners02.wav"
}
TLK_CIT_FEMALE_SEEN_SCANNER.CONCEPT=TLK_CONCEPT_SEEN_ENEMY

TLK_CIT_FEMALE_SEEN_STRIDER={
"vo/npc/female01/strider.wav"
}
TLK_CIT_FEMALE_SEEN_STRIDER.CONCEPT=TLK_CONCEPT_SEEN_ENEMY

TLK_CIT_FEMALE_SEEN_GUNSHIP={
"vo/coast/barn/female01/lite_gunship01.wav",
"vo/coast/barn/female01/lite_gunship02.wav"
}
TLK_CIT_FEMALE_SEEN_GUNSHIP.CONCEPT=TLK_CONCEPT_SEEN_ENEMY

TLK_CIT_FEMALE_SEEN_DROPSHIP={
"vo/coast/barn/female01/incomingdropship.wav"
}
TLK_CIT_FEMALE_SEEN_DROPSHIP.CONCEPT=TLK_CONCEPT_SEEN_ENEMY
